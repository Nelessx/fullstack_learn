  ...
  return (
    <div className=" w-8/12 mx-auto py-16">
      ...
      <div className=" flex flex-col items-center mb-4">
        ...
        <p className=" text-4xl font-semibold ">Frequently Asked Question</p>
      </div>
      <Accordion>
        <AccordionItem>
        ...
        <AccordionItem>
          <AccordionItemHeading>
            <AccordionItemButton>Is fredfttty illusion?</AccordionItemButton>
          </AccordionItemHeading>
          <AccordionItemPanel>
            <p>In ad velit in ex nostrud dolorey cyyyy ut nostrud velit in irure cillum tempor laboris sed adipisicing eu esse duis nulla non.</p>
          </AccordionItemPanel>
        </AccordionItem>
